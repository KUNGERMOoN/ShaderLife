...
//Stolen from: docs.unity3d.com/Manual/UIE-manipulators.html
public class Draggable : PointerManipulator
{
    public bool enabled = true;

    private VisualElement dragElement;
    private VisualElement dragSpace;
    ...
    protected void OnPointerMove(PointerMoveEvent e)
    {
        ...
        dragElement.style.top = Mathf.Clamp(dragElement.style.top.ToFloat() + diff.y, -spaceHeight / 2, spaceHeight / 2);
        dragElement.style.left = Mathf.Clamp(dragElement.style.left.ToFloat() + diff.x, -spaceWidth / 2, spaceWidth / 2);
